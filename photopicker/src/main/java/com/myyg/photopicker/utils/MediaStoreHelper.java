...
public class MediaStoreHelper {
    ...
    public static void getPhotoDirs(FragmentActivity activity, Bundle args, ArrayList<String> listFilterDir, PhotosResultCallback resultCallback) {
        activity.getSupportLoaderManager()
                .initLoader(0, args, new PhotoDirLoaderCallbacks(activity, listFilterDir, resultCallback));
    }
    ...
    static class PhotoDirLoaderCallbacks implements LoaderManager.LoaderCallbacks<Cursor> {
        ...
        private HashMap<String, String> hashMapFilterDir = new HashMap<>();
        ...
        public PhotoDirLoaderCallbacks(Context context, ArrayList<String> listFilterDir, PhotosResultCallback resultCallback) {
            this.context = context;
            if (listFilterDir != null) {
                for (String dir : listFilterDir) {
                    hashMapFilterDir.put(dir.toLowerCase(), dir);
                }
            }
            this.resultCallback = resultCallback;
        }
        ...
        public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
            ...
            while (data.moveToNext()) {
                ...
                if (hashMapFilterDir.containsKey(name.toLowerCase())) {
                    continue;
                }
