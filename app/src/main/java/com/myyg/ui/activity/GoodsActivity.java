...
public class GoodsActivity extends BaseActivity {
    ...
    public void initView() {
        this.setContentView(R.layout.activity_goods);
    ...
    public void fillView() {
        this.setToolBar("购物专区");
        this.goodsAdapter = new RecyclerAdapter<GoodsModel>(this.mContext, this.listGoods, R.layout.item_goods_list) {
            @Override
    ...
    private void loadData() {
        String url = MessageFormat.format("{0}/{1}/{2}", URLS.GOODS_SHOP_LIST, pageIndex, SysConstant.PAGE_SIZE);
