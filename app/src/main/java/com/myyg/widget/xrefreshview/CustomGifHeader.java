...
/**
 * Created by JOHN on 2016/5/29.
 */
public class CustomGifHeader extends LinearLayout implements IHeaderCallBack {
    private final static String TAG = CustomGifHeader.class.getSimpleName();
...
//        gifView1.setVisibility(View.VISIBLE);
    ...
    public void onHeaderMove(double offset, int offsetY, int deltaY) {
        MyLog.i(TAG, "Offset：" + offset);
        MyLog.i(TAG, "OffsetY：" + offsetY);
        MyLog.i(TAG, "DeltaY：" + deltaY);
    }
